...
File: iMessageBot Handler.applescript

Version: 1.0

Copyright 2017 Michael Sweetland
...
using terms from application "Messages"
    on message received theText from theBuddy for theChat
        ...
        do shell script "python /Users/michael/Desktop/iMessage-Bot/iMessageBot-sendToQueue.py " & quoted_message & " " & quoted_id & ""
        return true
